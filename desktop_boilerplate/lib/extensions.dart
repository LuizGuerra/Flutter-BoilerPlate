...
extension TypographyUtils on BuildContext {
  ...
  TextTheme get textTheme => Typography.whiteRedwoodCity;
...
enum Edge { all, vertical, horizontal, top, bottom, left, right }

extension WidgetPadding on Widget {
  Padding padding(Edge insets, double length) {
    if (insets == Edge.all) {
      return Padding(
    ...
    final edgeInsets = EdgeInsets.fromLTRB(
        insets == Edge.left || insets == Edge.horizontal ? length : 0,
        insets == Edge.top || insets == Edge.vertical ? length : 0,
        insets == Edge.right || insets == Edge.horizontal ? length : 0,
        insets == Edge.bottom || insets == Edge.vertical ? length : 0);
    return Padding(
      padding: edgeInsets,
      child: this,
    );
