import 'package:desktop_boilerplate/view/components/reusable_text_field.dart';
import 'package:desktop_boilerplate/view/components/string_button.dart';
import 'package:desktop_boilerplate/view/components/widget_button.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          StringButton("Connect", onPressed: buttonAction),
        ],
      ),
    );
  }
